        ...
        <div className="space-y-6">
            ...
            <CardContent className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <Input id="firstName" placeholder="Enter your first name" defaultValue="..." />
                </div>
                <div className="space-y-2">
                  <Label htmlFor="lastName">Last Name</Label>
                  <Input id="lastName" placeholder="Enter your last name" defaultValue="..." />
                </div>
              </div>
              
              <div className="space-y-2">
                <Label htmlFor="email">Email Address</Label>
                <Input id="email" type="email" placeholder="Enter your email" defaultValue="....@example.com" />
              </div>
            ...
            <CardContent className="space-y-6">
              ...
              <div className="flex items-center justify-between">
                <div className="space-y-0.5">
                  ...
                  <p className="text-sm text-gray-500">Notifications for discussions and replies</p>
                </div>
                <Switch />
              </div>
          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              ...
              <div className="flex items-center justify-between">
                <div className="space-y-0.5">
                  <Label>Skip Completed Lessons</Label>
                  <p className="text-sm text-gray-500">Skip lessons you've already completed</p>
                </div>
                <Switch />
              </div>
            </CardContent>
